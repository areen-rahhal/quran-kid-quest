 ...
 */
export async function loadProfilesForParent(parentId: string): Promise<Profile[]> {
  try {
 ...
 */
export async function createChildProfile(parentId: string, childData: Omit<Profile, 'id'>): Promise<Profile | null> {
  try {
