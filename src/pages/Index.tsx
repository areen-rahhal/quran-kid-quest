      ...
      <div className="container max-w-md mx-auto flex flex-col items-center justify-center flex-1 relative z-10">
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            className="px-12 py-4 bg-emerald-500 text-white font-bold text-lg rounded-full hover:bg-emerald-600 transition-all shadow-lg hover:shadow-xl active:scale-95"
          >
            Create Account
          </button>
          <button
