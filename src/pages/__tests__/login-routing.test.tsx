        ...
        const profiles = [
          {
            ...
            goals: [
              { id: 'goal-1', goalId: 'juz-30', name: 'Juz 30', phaseSize: 1, status: 'in-progress' as const },
              { id: 'goal-2', goalId: 'surah-bakarah', name: 'Surah Al-Bakarah', phaseSize: 1, status: 'in-progress' as const },
            ],
            goalsCount: 2,
            avatar: 'avatar-deer',
        ...
        const profiles = [
          {
            ...
            name: 'Parent',
            type: 'parent' as const,
            goals: [{ id: '1', goalId: 'juz-30', name: 'Juz 30', phaseSize: 1, status: 'in-progress' as const }],
            goalsCount: 1,
            avatar: 'avatar-deer',
          ...
          },
          {
            ...
            type: 'child' as const,
            goals: [
              { id: '2', goalId: 'surah-bakarah', name: 'Surah Al-Bakarah', phaseSize: 1, status: 'in-progress' as const },
              { id: '3', goalId: 'juz-29', name: 'Juz 29', phaseSize: 1, status: 'in-progress' as const },
            ],
            goalsCount: 2,
            parentId: 'parent-1',
            avatar: 'avatar-bear',
        ...
        const existingUserProfile = [
          {
            ...
            type: 'parent' as const,
            goals: [
              { id: '1', goalId: 'juz-30', name: 'Juz 30', phaseSize: 1, status: 'in-progress' as const },
              { id: '2', goalId: 'surah-bakarah', name: 'Surah Al-Bakarah', phaseSize: 1, status: 'in-progress' as const },
            ],
            goalsCount: 2,
            avatar: 'avatar-deer',
    ...
    it('should handle user with only child goals (parent has 0, children have goals)', () => {
      const profiles = [
        ...
        },
        {
          ...
          goals: [
            { id: '1', goalId: 'juz-30', name: 'Juz 30', phaseSize: 1, status: 'in-progress' as const },
            { id: '2', goalId: 'juz-29', name: 'Juz 29', phaseSize: 1, status: 'in-progress' as const },
          ],
          goalsCount: 2,
          parentId: 'parent-1',
          avatar: 'avatar-bear',
    ...
    it('should handle multiple children with different goal counts', () => {
      const profiles = [
        ...
        },
        {
          ...
          goals: [
            { id: '2', goalId: 'juz-29', name: 'Juz 29', phaseSize: 1, status: 'in-progress' as const },
            { id: '3', goalId: 'surah-bakarah', name: 'Surah Al-Bakarah', phaseSize: 1, status: 'in-progress' as const },
          ],
          goalsCount: 2,
          parentId: 'parent-1',
          avatar: 'avatar-bear',
        ...
        },
        {
          ...
          name: 'Child 3',
          type: 'child' as const,
          goals: [{ id: '4', goalId: 'juz-1', name: 'Juz 1', phaseSize: 1, status: 'in-progress' as const }],
          goalsCount: 1,
          parentId: 'parent-1',
          avatar: 'avatar-tiger',
          achievements: { stars: 0, streak: 0, recitations: 0, goalsCompleted: 0 },
